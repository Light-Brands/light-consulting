...
const PLACEHOLDER_PROJECTS: Project[] = [
  ...
  },
  {
    id: '8',
    title: 'VIBEUP',
    description: 'Beta community platform extending the VIBEUP ecosystem. Full-stack development with UI/UX design and brand identity. Features social feeds, messaging, community features, and user profiles with real-time messaging.',
    image_url: '/images/portfolio/vibeup.jpg',
    tags: ['Social Platform', 'Community', 'Real-time', 'React', 'Full-stack'],
    case_study_url: 'https://vibeup.io',
    client_name: 'VIBEUP',
