/**
 * Funnel Page 26: AI ROI Audit (Tier 2)
 * Light Brand Consulting
 *
 * Page Function: Measure and optimize AI investment returns
 * - Target: Organizations where fewer than 30% of CEOs are satisfied with AI returns
 * - Hook: "Is Your AI Actually Delivering Value?"
 * - Entry: AI ROI Assessment
 */
...
interface FunnelPage26Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage26: React.FC<FunnelPage26Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                Fewer than 30% of CEOs are satisfied with their AI returns.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                Most companies can't measure AI ROI because they never defined it.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                You've invested in AI. Now let's find out if it's working
                and what to do about it.
              </p>
              <div className="pt-2">
                <p className="text-radiance-gold text-xl font-semibold">
                  Measure what matters. Optimize what's working. Fix what isn't.
                </p>
              </div>
            </div>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              AI Investment Without
              <span className="block text-radiance-amber mt-2">Measurable Returns</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 relative z-10">
            <div className="p-8 rounded-2xl border border-depth-border bg-depth-surface/30 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-6">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Common_ROI_Failures</span>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    'No clear baseline established before AI implementation',
                    'Success metrics never defined or tracked',
                    'Costs scattered and hard to aggregate',
                    'Benefits are "soft" and hard to quantify',
                    'No framework for ongoing measurement',
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm text-center">
                <p className="text-4xl font-bold text-radiance-amber mb-2">70%</p>
                <p className="text-text-muted text-sm">of CEOs dissatisfied with AI returns</p>
              </div>
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm text-center">
                <p className="text-4xl font-bold text-radiance-amber mb-2">60%</p>
                <p className="text-text-muted text-sm">can't measure their AI ROI</p>
              </div>
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm text-center">
                <p className="text-4xl font-bold text-radiance-amber mb-2">45%</p>
                <p className="text-text-muted text-sm">never set clear AI success metrics</p>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Complete AI ROI Analysis
            </h2>
            <p className="text-xl text-radiance-gold font-medium">
              Finally understand what your AI investment is delivering
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  title: 'Cost Analysis',
                  description: 'Full accounting of AI investment including hidden costs and ongoing expenses',
                  icon: (
                ...
                {
                  title: 'Value Mapping',
                  description: 'Quantify both hard returns and soft benefits in business terms',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Measure actual usage vs. expected usage across the organization',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Technical performance vs. business impact correlation',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'What you could have done with this investment instead',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Specific actions to improve ROI on current investments',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      "You've invested in AI but can't prove the returns",
                      "Leadership is questioning continued AI investment",
                      "You suspect some AI initiatives are underperforming",
                      "You need to justify AI budget for next year",
                      "You want to optimize existing AI investments before adding more",
                    ].map((item, index) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      "Organizations without existing AI investments",
                      "Companies just starting their AI journey",
                      "Teams looking for implementation help",
                      "Businesses not willing to make changes based on findings",
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
      ...
      <section className="section-spacing bg-gradient-to-b from-depth-base to-depth-elevated relative overflow-hidden">
        ...
        <Container size="narrow">
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-xl text-radiance-gold font-medium">
              Finally get clarity on what your AI investment is delivering.
            </p>
        ...
        <Container size="narrow" className="text-center">
          <div className="relative z-10 flex items-center justify-center gap-2">
            ...
            <p className="text-text-muted">
              ...
              measure and optimize their AI investments.
            </p>
            <span className="w-2 h-2 rounded-full bg-radiance-gold/30" />
          </div>
        </Container>
