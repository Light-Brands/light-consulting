/**
 * Funnel Page 16: AI for E-Commerce
 * Light Brand Consulting
 *
 * Page Function: Industry-specific AI for e-commerce and DTC brands
 * - Target: DTC brands, retailers, marketplaces
 * - Hook: "AI That Understands E-Commerce"
 * - Entry: E-Commerce AI Opportunity Map ($1,500-3,500)
 */
...
interface FunnelPage16Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage16: React.FC<FunnelPage16Props> = ({ onNavigate }) => {
  return (
    <div className="w-full">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                DTC brands. Retailers. Marketplaces.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                Every competitor is adding AI. The winners will use it strategically.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                Personalization at scale. Inventory intelligence. Customer experience that converts.
              </p>
              <div className="pt-2">
                <p className="text-radiance-gold text-xl font-semibold">
                  E-commerce runs on margins. AI expands them.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 animate-slide-up delay-400">
              ...
              >
                Get Your E-Commerce AI Map
              </Button>
            </div>

            <p className="text-text-muted text-sm animate-fade-in delay-500">
              Industry-specific analysis · 2-week engagement · Revenue-focused roadmap
            </p>
          </div>
        </Container>
      ...
      {/* The E-Commerce AI Challenge Section */}
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              E-Commerce Faces
              <span className="block text-radiance-amber mt-2">Unique AI Opportunities</span>
            </h2>
          </div>
            ...
            <div className="p-8 rounded-2xl border border-depth-border bg-depth-surface/30 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-6">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Industry_Pressures</span>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    'Rising customer acquisition costs',
                    'Inventory prediction challenges',
                    'Content creation at scale demands',
                    'Customer service volume pressures',
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Tool_Chaos</span>
                </div>
                <p className="text-text-muted italic">"We have 15 different AI tools, but no strategy."</p>
              </div>
              <div className="p-6 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Strategic_AI</span>
                </div>
                <p className="text-text-primary italic">"We have an AI system that directly increases revenue and margins."</p>
              </div>
            </div>
          </div>
        </Container>
      ...
      {/* AI Opportunities for E-Commerce Section */}
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Where AI Drives E-Commerce Revenue
            </h2>
            <p className="text-xl text-radiance-gold font-medium">
              AI applications with direct revenue impact
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Personalized recommendations that increase AOV and conversion rates',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'AI agents that handle support at scale while improving satisfaction',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Product descriptions, marketing copy, and creative at scale',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Dynamic pricing strategies that maximize revenue and margins',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Deep insights into behavior, segments, and lifetime value',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary">
              AI Impact Across the E-Commerce Stack
            </h2>
          </div>
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { metric: '15-30%', area: 'Conversion increase from personalization' },
                { metric: '20-40%', area: 'Support cost reduction with AI agents' },
                { metric: '10-25%', area: 'Inventory cost savings from prediction' },
                { metric: '5-15%', area: 'Revenue lift from dynamic pricing' },
              ].map((item, index) => (
                <div key={index} className="p-5 rounded-xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm hover:border-radiance-gold/30 transition-all text-center">
                  <p className="text-radiance-gold font-bold text-2xl mb-2">{item.metric}</p>
                  <p className="text-text-muted text-sm">{item.area}</p>
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  ...
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      "You run a DTC brand, retailer, or marketplace",
                      "You want AI that directly impacts revenue metrics",
                      "You're spending too much on customer acquisition",
                      "You need to scale content and customer service",
                      "You want to lead with personalization, not follow",
                    ].map((item, index) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      "Companies outside e-commerce or retail",
                      "Brands looking for quick-fix AI tools only",
                      "Organizations not ready to invest in strategy",
                      "Those without existing revenue data to analyze",
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
      ...
      <section className="section-spacing relative overflow-hidden">
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              From Analysis to Revenue Impact
            </h2>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            {[
              {
                step: 1,
                title: 'E-Commerce AI Opportunity Map',
                text: 'Deep analysis of your business, data, and highest-impact AI opportunities.',
                price: '$1,500-3,500',
              },
              {
                step: 2,
                title: 'Revenue-Focused Roadmap',
                text: 'Prioritized implementation plan with projected ROI for each initiative.',
                price: 'Included',
              },
              {
                step: 3,
                title: 'AI Intelligence Build',
                text: 'Custom AI systems designed for e-commerce with measurable revenue impact.',
                price: 'Custom',
              }
            ].map((item, idx) => (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="relative inline-block">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary relative z-10">
                Ready to unlock AI-driven revenue growth?
              </h2>
            </div>

            <p className="text-xl text-radiance-gold font-medium">
              Get an AI strategy built specifically for e-commerce.
            </p>
            ...
            <p className="text-text-muted text-sm font-mono tracking-wider">
              <span className="opacity-40">//</span> Industry-specific <span className="opacity-40">·</span> 2-week engagement <span className="opacity-40">·</span> $1,500-3,500 <span className="opacity-40">//</span>
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            <p className="text-lg text-text-secondary">
              Every e-commerce company is adding AI.
            </p>
            <p className="text-xl text-text-primary font-medium">
              The winners will use it strategically.
            </p>
