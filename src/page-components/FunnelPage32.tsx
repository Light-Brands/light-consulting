/**
 * Funnel Page 32: Business for Retreat Leaders (Tier 3)
 * Light Brand Consulting
 *
 * Page Function: Modality-specific funnel for retreat leaders
 * - Target: Retreat facilitators, wellness travel leaders, transformational experience creators
 * - Hook: "Your Retreat Changes Lives. Now Build a Business Around It."
 * - Entry: Retreat Business Blueprint ($2,500-$5,000)
 */
...
interface FunnelPage32Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage32: React.FC<FunnelPage32Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                Wellness travel is a $919B market growing 16.6% annually.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                But most retreat leaders are running retreats, not retreat businesses.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                You create transformational experiences. But filling seats, managing logistics,
                and building recurring revenue? That&apos;s a different skill set.
              </p>
              <div className="pt-2">
                <p className="text-radiance-gold text-xl font-semibold">
                  Turn your retreat gift into a sustainable retreat business.
                </p>
              </div>
            </div>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            <Tag variant="default" className="mx-auto mb-6 backdrop-blur-sm">
              The Retreat Leader&apos;s Challenge
            </Tag>
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              Amazing at Retreats.
              <span className="block text-radiance-amber mt-2">Struggling With the Business.</span>
            </h2>
          </div>
            ...
            <div className="p-8 rounded-2xl border border-depth-border bg-depth-surface/30 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-6">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Retreat_Leader_Struggles</span>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    'Filling seats is a constant hustle, retreat after retreat',
                    'Venue deposits and logistics drain your cash flow',
                    'No income between retreats creates financial stress',
                    'Pricing feels like guesswork with thin margins',
                    'Marketing your retreat feels inauthentic',
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Retreat_Hobby</span>
                </div>
                <p className="text-text-muted italic">&ldquo;I run retreats when I can fill them. In between, I scramble.&rdquo;</p>
              </div>
              <div className="p-6 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Retreat_Business</span>
                </div>
                <p className="text-text-primary italic">&ldquo;I have a year of retreats planned, waitlists building, and recurring revenue flowing.&rdquo;</p>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            <Tag variant="premium" className="mx-auto mb-6 backdrop-blur-sm">
              Retreat Business Blueprint
            </Tag>
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Build a Sustainable Retreat Business
            </h2>
            <p className="text-xl text-radiance-gold font-medium">
              From one-off events to a thriving retreat enterprise
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Map out your retreat calendar for consistent, predictable income',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'Price for profitability, not just break-even margins',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {
                  title: 'Fill Strategy',
                  description: 'Build waitlists and fill retreats without constant hustle',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Streamline operations so you can focus on facilitation',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {
                  title: 'Revenue Bridges',
                  description: 'Create income streams between retreats for stability',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Build relationships that reduce costs and improve terms',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {[
              {
                ...
                desc: 'Create a retreat business model with predictable revenue and sustainable margins',
              },
              {
                step: '2',
                title: 'Annual Retreat Calendar',
                desc: 'Plan your year of retreats with strategic timing and pricing',
              },
              {
                step: '3',
                title: 'Fill System',
                desc: 'Build the audience and systems that fill retreats without constant promotion',
              },
              {
                step: '4',
                title: 'Operations Playbook',
                desc: 'Document and systematize everything so retreats run smoothly',
              },
            ].map((item, idx) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      'You lead transformational retreats and want to do more',
                      'Filling seats feels like a constant hustle',
                      'You want predictable income, not feast-or-famine',
                      'You\'re ready to build a real retreat business',
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      'Those who haven\'t led a retreat yet',
                      'Retreat leaders happy with occasional events',
                      'People looking for quick-fix marketing tactics',
                      'Those unwilling to invest in business development',
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
        ...
        <Container size="wide">
          ...
          <div className="max-w-xl mx-auto relative z-10">
            <div className="p-8 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm relative">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 rounded-full bg-radiance-gold shadow-[0_0_8px_rgba(232,184,74,0.6)]" />
                <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Business_Blueprint</span>
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-2">Retreat Business Blueprint</h3>
              <p className="text-radiance-gold text-xl font-semibold mb-4">$2,500 - $5,000</p>
              <p className="text-text-secondary text-sm mb-6">6-10 week program to transform your retreat passion into a sustainable business</p>
              <ul className="space-y-3">
                {[
                  'Complete business model design',
                  'Annual retreat calendar',
                  'Pricing and profitability framework',
                  'Fill system development',
                  'Operations playbook',
                  'Revenue bridge strategy',
                  'Venue partnership guidance',
                ].map((item, index) => (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="relative inline-block">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary relative z-10">
                Ready to build a retreat business?
              </h2>
            </div>

            <p className="text-xl text-radiance-gold font-medium">
              Your retreat gift deserves a sustainable business around it.
            </p>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            <p className="text-lg text-text-secondary">
              Wellness travel is a $919B market. But most retreat leaders barely break even.
            </p>
            <p className="text-xl text-text-primary font-medium">
              You create transformational experiences.
            </p>
            <p className="text-2xl text-radiance-gold font-semibold">
              Time to build a business worthy of your gift.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow" className="text-center">
          <div className="relative z-10 flex items-center justify-center gap-2">
            ...
            <p className="text-text-muted">
              <span className="text-radiance-gold font-medium">Light Brand</span> helps retreat leaders
              build sustainable, thriving retreat businesses.
            </p>
            <span className="w-2 h-2 rounded-full bg-radiance-gold/30" />
          </div>
        </Container>
