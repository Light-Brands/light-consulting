/**
 * Funnel Page 27: Agentic AI Readiness (Tier 2)
 * Light Brand Consulting
 *
 * Page Function: Prepare organizations for autonomous AI agents
 * - Target: Forward-thinking companies preparing for the agentic AI wave
 * - Hook: "2026 Is the Year of Agentic AI. Are You Ready?"
...
interface FunnelPage27Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage27: React.FC<FunnelPage27Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                AI agents that act autonomously are coming.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                They'll transform how work gets done. Will you be ready?
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                From copilots to autonomous agents. The next wave of AI will work for you, not just with you.
                Prepare your organization before the wave hits.
              </p>
              <div className="pt-2">
            ...
            <p className="text-text-muted text-sm animate-fade-in delay-500">
              Future-proofing · Strategic preparation · Early mover advantage
            </p>
          </div>
        </Container>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              From Assistants to
              <span className="block text-radiance-amber mt-2">Autonomous Agents</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm">
                ...
                <h3 className="text-xl font-bold text-text-muted mb-4">AI Copilots</h3>
              ...
              <div className="p-6 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Future_State</span>
                </div>
                <h3 className="text-xl font-bold text-text-primary mb-4">AI Agents</h3>
                <ul className="space-y-3">
                  {[
                    'Act and execute autonomously',
            ...
            <div className="p-8 bg-depth-elevated/50 rounded-2xl border border-depth-border text-center backdrop-blur-sm relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <p className="text-text-secondary mb-2">The transformation is happening:</p>
                <p className="text-radiance-gold font-semibold text-xl">
                  AI will go from working with you to working for you.
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Agents that research, synthesize, and report back with insights',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'Complex multi-step processes handled end-to-end',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Agents that make decisions within defined guardrails',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Agents that move between tools and platforms seamlessly',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Agents that watch, alert, and act on your behalf',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Agents that improve their performance over time',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {[
              {
                ...
                desc: 'Can your systems support autonomous AI agents?',
              },
              {
                step: '2',
                title: 'Governance Framework',
                desc: 'Do you have guardrails for autonomous decision-making?',
              },
              {
                step: '3',
                title: 'Process Suitability',
                desc: 'Which workflows are ready for agent automation?',
              },
              {
                step: '4',
                title: 'Team Preparedness',
                desc: 'Is your organization ready to work alongside agents?',
              },
            ].map((item, idx) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      "You want to be ahead of the agentic AI wave, not behind it",
                      "You're already using AI copilots and ready for the next level",
                      "You want to understand what infrastructure changes are needed",
                      "You need a strategic roadmap for agentic AI adoption",
                      "You're concerned about governance for autonomous AI",
                    ].map((item, index) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      "Organizations just starting their AI journey",
                      "Companies not yet using AI copilots successfully",
                      "Businesses looking for immediate AI implementation",
                      "Teams not willing to invest in future-proofing",
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
      ...
      <section className="section-spacing bg-gradient-to-b from-depth-elevated to-depth-base relative overflow-hidden">
        ...
        <Container size="narrow">
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-xl text-radiance-gold font-medium">
              Get ahead of the wave, not caught in it.
            </p>
            ...
            <p className="text-text-muted text-sm font-mono tracking-wider">
              <span className="opacity-40">//</span> Future-proofing <span className="opacity-40">·</span> Strategic preparation <span className="opacity-40">·</span> Early advantage <span className="opacity-40">//</span>
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            ...
            <p className="text-xl text-text-primary font-medium">
              The question isn't if, it's when. And whether you'll be ready.
            </p>
            <p className="text-2xl text-radiance-gold font-semibold">
              2026 is the year of agentic AI. Prepare now.
            </p>
          </div>
        </Container>
      </section>
