/**
 * Funnel Page 35: Annual Light Workers Summit (Tier 4)
 * Light Brand Consulting
 *
 * Page Function: Annual conference/summit for light worker entrepreneurs
 * - Target: Light workers seeking community and advanced learning
 * - Hook: "The Annual Gathering for Purpose-Driven Entrepreneurs"
 * - Entry: Summit Tickets ($297-$997)
 */
...
interface FunnelPage35Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage35: React.FC<FunnelPage35Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                Three days of transformation, connection, and strategy.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                Where light workers come to learn, connect, and accelerate their impact.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                Join hundreds of purpose-driven entrepreneurs for the event that defines
                the year in light worker business building.
              </p>
              <div className="pt-2">
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              ...
              <span className="block text-radiance-amber mt-2">Transform Your Business</span>
            </h2>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Learn from industry leaders who\'ve built thriving purpose-driven businesses',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'Hands-on sessions to implement strategies before you leave',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Build relationships with fellow light workers that last beyond the event',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Small group sessions for personalized problem-solving',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Meditation, movement, and integration practices woven throughout',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Leave with a clear action plan for the year ahead',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {[
              {
                day: 'Day 1',
                title: 'Foundation',
                desc: 'Keynotes on purpose-driven business building, opening ceremony, and community connection',
                highlights: ['Opening keynote', 'Vision workshop', 'Welcome dinner'],
              },
              {
                day: 'Day 2',
                title: 'Implementation',
                desc: 'Deep-dive workshops, mastermind sessions, and hands-on strategy development',
                highlights: ['Strategy workshops', 'Mastermind groups', 'Expert panels'],
              },
              {
                day: 'Day 3',
                title: 'Integration',
                desc: 'Action planning, closing keynote, and future community connection',
                highlights: ['Action planning', 'Closing keynote', 'Commitment ceremony'],
              },
            ].map((item, idx) => (
              <div key={item.day} className="relative group">
                {/* Connecting line */}
                {idx < 2 && (
                  <div className="absolute left-6 top-[100%] w-px h-8 bg-gradient-to-b from-radiance-gold/30 to-transparent" />
                )}

                <div className="p-6 bg-depth-surface/30 border border-depth-border rounded-2xl backdrop-blur-sm hover:border-radiance-gold/30 transition-all">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-radiance-gold/20 text-radiance-gold flex items-center justify-center font-bold flex-shrink-0 font-mono shadow-[0_0_20px_rgba(232,184,74,0.2)] group-hover:shadow-[0_0_30px_rgba(232,184,74,0.4)] transition-shadow">
                      {idx + 1}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-radiance-gold text-sm font-mono">{item.day}</span>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.highlights.map((highlight, hidx) => (
                          <span key={hidx} className="px-2 py-1 text-xs rounded-full bg-radiance-gold/10 text-radiance-gold border border-radiance-gold/20">
                            {highlight}
                          </span>
                        ))}
                      </div>
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      'You\'re ready for immersive learning and transformation',
                      'You want to connect with a values-aligned community',
                      'You learn best through in-person experiences',
                      'You\'re committed to accelerating your business growth',
                      'You value expert guidance and peer support',
                    ].map((item, index) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      'Those who prefer online-only learning',
                      'People not ready to invest in their growth',
                      'Light workers just starting their journey',
                      'Those unable to commit to three full days',
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-8 rounded-2xl bg-depth-surface/30 border border-depth-border backdrop-blur-sm hover:border-radiance-gold/30 transition-all">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">General_Admission</span>
                </div>
                <h3 className="text-2xl font-bold text-text-primary mb-2">General Admission</h3>
                <p className="text-radiance-gold text-xl font-semibold mb-4">$297 - $497</p>
                <p className="text-text-secondary text-sm mb-4">Full access to all summit sessions and community events</p>
              ...
              <div className="p-8 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm relative">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-2 h-2 rounded-full bg-radiance-gold shadow-[0_0_8px_rgba(232,184,74,0.6)]" />
                  <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">VIP_Access</span>
                </div>
                <h3 className="text-2xl font-bold text-text-primary mb-2">VIP Experience</h3>
                <p className="text-radiance-gold text-xl font-semibold mb-4">$697 - $997</p>
                <p className="text-text-secondary text-sm mb-4">Premium summit experience with exclusive access and benefits</p>
                <ul className="space-y-3">
                  {[
        ...
        <Container size="narrow">
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-xl text-radiance-gold font-medium">
              Join us for three days that will define your year.
            </p>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            <p className="text-lg text-text-secondary">
              The most impactful growth happens when we come together.
            </p>
            <p className="text-xl text-text-primary font-medium">
              Three days of learning, connection, and transformation.
            </p>
            <p className="text-2xl text-radiance-gold font-semibold">
              This is where light workers come to level up.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow" className="text-center">
          <div className="relative z-10 flex items-center justify-center gap-2">
            ...
            <p className="text-text-muted">
              <span className="text-radiance-gold font-medium">Light Workers Summit</span>
              is the annual gathering for purpose-driven entrepreneurs.
            </p>
            <span className="w-2 h-2 rounded-full bg-radiance-gold/30" />
          </div>
        </Container>
