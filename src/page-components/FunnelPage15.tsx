        ...
        <Container size="wide" className="relative z-10 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-text-muted text-sm animate-fade-in delay-500">
              Industry-specific analysis · 2-week engagement · Actionable roadmap
            </p>
          </div>
        </Container>
        ...
        <Container size="narrow">
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-text-muted text-sm font-mono tracking-wider">
              <span className="opacity-40">//</span> Industry-specific <span className="opacity-40">·</span> 2-week engagement <span className="opacity-40">·</span> $2,500-5,000 <span className="opacity-40">//</span>
            </p>
          </div>
        </Container>
      </section>
