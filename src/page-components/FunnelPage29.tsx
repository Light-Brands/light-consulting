/**
 * Funnel Page 29: Business for Healers (Tier 3)
 * Light Brand Consulting
 *
 * Page Function: Modality-specific funnel for energy healers
 * - Target: Energy healers, Reiki practitioners, intuitive healers, bodyworkers
 * - Hook: "Your Healing Gift Deserves a Business That Honors It"
 * - Entry: Healer's Business Foundation ($1,500-$3,500)
 */
...
interface FunnelPage29Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage29: React.FC<FunnelPage29Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                82% of healing practices fail within 3 years.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                Not because the healing isn&apos;t real. Because no one taught you to build a business.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                You spent years developing your healing gifts. But running a practice?
                That&apos;s a different skill set entirely.
              </p>
              <div className="pt-2">
                <p className="text-radiance-gold text-xl font-semibold">
                  Business and healing can coexist. Let us show you how.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 animate-slide-up delay-400">
              ...
              >
                Build Your Healer&apos;s Foundation
              </Button>
            </div>

            <p className="text-text-muted text-sm animate-fade-in delay-500">
              Values-aligned · Energy-protecting · Sustainably profitable
            </p>
          </div>
        </Container>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              Business Feels Antithetical
              <span className="block text-radiance-amber mt-2">To Your Healing Work</span>
            </h2>
          </div>
            ...
            <div className="p-8 rounded-2xl border border-depth-border bg-depth-surface/30 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-6">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-text-muted uppercase">Healer_Struggles</span>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    'Pricing your work feels like putting a price on healing',
                    'Marketing feels manipulative when your work is sacred',
                    'Energy vampires drain you instead of paying clients',
                    'You\'re trading time for money with no end in sight',
                    'Building trust with skeptics seems impossible',
                    'Testimonials feel awkward for intangible transformation',
                  ].map((item, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Abundance_Mode</span>
                </div>
                <p className="text-text-primary italic">&ldquo;Sustainable income lets me serve more people, more deeply.&rdquo;</p>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            <Tag variant="premium" className="mx-auto mb-6 backdrop-blur-sm">
              Healer&apos;s Business Foundation
            </Tag>
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Build a Practice That Sustains Your Gift
            </h2>
            <p className="text-xl text-radiance-gold font-medium">
              Business infrastructure designed specifically for healers
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Price transformational work without guilt or undervaluing your gifts',
                  icon: (
                ...
                {
                  title: 'Client Journey Design',
                  description: 'Guide skeptics to believers through authentic transformation paths',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Create credibility in spaces where skepticism is common',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Systems and boundaries that prevent client drain',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Capture transformation evidence for intangible services',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Move beyond trading time for money to scalable impact',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Container size="wide">
          ...
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            {[
              {
                step: '1',
                title: 'Healing Practice Positioning',
                desc: 'Clarify your unique modality and ideal client so you attract aligned seekers',
              },
              {
                step: '2',
                title: 'Sacred Pricing Framework',
                desc: 'Price your transformational work in a way that honors both you and your clients',
              },
              {
                step: '3',
                title: 'Client Journey Map',
                desc: 'Design the path from first discovery to deep transformation and referral',
              },
              {
                step: '4',
                title: 'Energy-Protecting Systems',
                desc: 'Boundaries, automation, and structures that preserve your energy for healing',
              },
            ].map((item, idx) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      'You\'re an energy healer, Reiki practitioner, or intuitive healer',
                      'Business feels like it conflicts with your healing mission',
                      'You struggle to price your transformational work',
                      'Clients drain your energy instead of energizing you',
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      'Healers who haven\'t developed their core modality yet',
                      'Those looking for get-rich-quick schemes',
                      'Practitioners unwilling to invest in their business',
                      'People who believe money and healing can\'t coexist',
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
        ...
        <Container size="wide">
          ...
          <div className="max-w-xl mx-auto relative z-10">
            <div className="p-8 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm relative">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 rounded-full bg-radiance-gold shadow-[0_0_8px_rgba(232,184,74,0.6)]" />
                <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Complete_Foundation</span>
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-2">Healer&apos;s Business Foundation</h3>
              <p className="text-radiance-gold text-xl font-semibold mb-4">$1,500 - $3,500</p>
              <p className="text-text-secondary text-sm mb-6">6-8 week intensive to build the business infrastructure your healing practice deserves</p>
              <ul className="space-y-3">
                {[
                  'Complete practice positioning',
                  'Sacred pricing framework',
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="relative inline-block">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary relative z-10">
                Ready to build a practice that honors your gift?
              </h2>
            </div>

            <p className="text-xl text-radiance-gold font-medium">
              Your healing work is sacred. Your business can be too.
            </p>
            ...
            <p className="text-text-muted text-sm font-mono tracking-wider">
              <span className="opacity-40">//</span> Ethical pricing <span className="opacity-40">·</span> Energy protection <span className="opacity-40">·</span> Sustainable practice <span className="opacity-40">//</span>
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            <p className="text-lg text-text-secondary">
              82% of healing practices fail. Not because the healing isn&apos;t real.
            </p>
            <p className="text-xl text-text-primary font-medium">
              Because building a business is a different skill than healing.
            </p>
            <p className="text-2xl text-radiance-gold font-semibold">
              You deserve both. We help you build both.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow" className="text-center">
          <div className="relative z-10 flex items-center justify-center gap-2">
            ...
            <p className="text-text-muted">
              <span className="text-radiance-gold font-medium">Light Brand</span> helps healers
              build businesses that honor their sacred work.
            </p>
            <span className="w-2 h-2 rounded-full bg-radiance-gold/30" />
          </div>
        </Container>
