/**
 * Funnel Page 34: Light Leader Newsletter (Tier 4)
 * Light Brand Consulting
 *
 * Page Function: Thought leadership newsletter for light worker entrepreneurs
 * - Target: Light workers wanting ongoing business insights
 * - Hook: "Weekly Wisdom for Purpose-Driven Entrepreneurs"
 * - Entry: Free Newsletter (with premium upgrade option)
 */
...
interface FunnelPage34Props {
  onNavigate: (page: PageKey) => void;
}

export const FunnelPage34: React.FC<FunnelPage34Props> = ({ onNavigate }) => {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-4 animate-slide-up delay-200">
              <p className="text-xl md:text-2xl text-text-secondary leading-relaxed">
                Business insights that honor your values.
              </p>
              <p className="text-xl md:text-2xl text-text-primary font-medium">
                No hustle culture. No manipulation tactics. Just wisdom that works.
              </p>
            </div>

            <div className="pt-4 max-w-2xl mx-auto animate-slide-up delay-300 space-y-3">
              <p className="text-text-muted leading-relaxed">
                Join thousands of light workers who receive weekly insights on building
                sustainable, values-aligned businesses that create real impact.
              </p>
              <div className="pt-2">
        ...
        <Container size="wide">
          <div className="text-center mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">
              ...
              <span className="block text-radiance-amber mt-2">Actionable Wisdom</span>
            </h2>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Practical insights for building sustainable, purpose-driven businesses',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'Attract aligned clients without manipulation or sleazy tactics',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Overcome the beliefs that keep light workers playing small',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {
                  title: 'Real Stories',
                  description: 'Case studies and examples from thriving light worker businesses',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'Stay ahead of changes in the purpose-driven business landscape',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  ...
                  description: 'First access to events, resources, and opportunities',
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Container size="wide">
          ...
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            {[
              {
                step: '1',
                title: 'The Main Insight',
                desc: 'One deep-dive topic with actionable takeaways you can implement immediately',
              },
              {
                step: '2',
                title: 'Quick Win',
                desc: 'A simple tactic or tip you can apply in under 10 minutes',
              },
              {
                step: '3',
                title: 'Spotlight Story',
                desc: 'Real examples from the light worker community to inspire and teach',
              },
              {
                step: '4',
                title: 'Resource Roundup',
                desc: 'Curated tools, articles, and resources for purpose-driven entrepreneurs',
              },
            ].map((item, idx) => (
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-radiance-gold/30 bg-radiance-gold/5 backdrop-blur-sm flex-1 relative">
                  <ul className="space-y-3.5 relative z-10">
                    {[
                      'You\'re a light worker building or growing a business',
                      'Traditional business advice feels out of alignment',
                      'You want consistent, values-aligned insights',
                      'You prefer learning through regular, digestible content',
              ...
              <div className="space-y-6 flex flex-col h-full">
                ...
                <div className="p-6 rounded-2xl border-l-2 border-depth-border/30 bg-depth-surface/30 backdrop-blur-sm flex-1">
                  <ul className="space-y-3.5">
                    {[
                      'Those looking for aggressive growth tactics',
                      'People who prefer hustle-culture approaches',
                      'Those who want manipulation-based marketing',
                      'Entrepreneurs focused only on profit maximization',
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3">
          ...
          <div className="max-w-xl mx-auto relative z-10">
            <div className="p-8 rounded-2xl bg-radiance-gold/5 border border-radiance-gold/30 backdrop-blur-sm relative">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="w-2 h-2 rounded-full bg-radiance-gold shadow-[0_0_8px_rgba(232,184,74,0.6)]" />
                <span className="text-[10px] font-mono tracking-widest text-radiance-gold uppercase">Weekly_Wisdom</span>
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-2">Light Leader Newsletter</h3>
              <p className="text-radiance-gold text-xl font-semibold mb-4">Free</p>
              <p className="text-text-secondary text-sm mb-6">Weekly insights for building a purpose-driven business</p>
              <ul className="space-y-3 mb-6">
                {[
                  'Weekly email with actionable insights',
                  'Exclusive content not published elsewhere',
                  'First access to new resources and events',
                  'Community connection and stories',
                  'Unsubscribe anytime',
                ].map((item, index) => (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="relative inline-block">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary relative z-10">
                Ready for wisdom that aligns with your values?
              </h2>
            </div>

            <p className="text-xl text-radiance-gold font-medium">
              Join thousands of light workers who start their week with purpose.
            </p>
            ...
            <p className="text-text-muted text-sm font-mono tracking-wider">
              <span className="opacity-40">//</span> Weekly insights <span className="opacity-40">·</span> No spam <span className="opacity-40">·</span> Unsubscribe anytime <span className="opacity-40">//</span>
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow">
          <div className="max-w-3xl mx-auto text-center space-y-6 relative z-10">
            <p className="text-lg text-text-secondary">
              Business advice shouldn&apos;t require you to compromise your values.
            </p>
            <p className="text-xl text-text-primary font-medium">
              Every week, get insights designed for light workers.
            </p>
            <p className="text-2xl text-radiance-gold font-semibold">
              Build your business the purpose-driven way.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container size="narrow" className="text-center">
          <div className="relative z-10 flex items-center justify-center gap-2">
            ...
            <p className="text-text-muted">
              <span className="text-radiance-gold font-medium">Light Leader</span> newsletter
              delivers weekly wisdom for purpose-driven entrepreneurs.
            </p>
            <span className="w-2 h-2 rounded-full bg-radiance-gold/30" />
          </div>
        </Container>
