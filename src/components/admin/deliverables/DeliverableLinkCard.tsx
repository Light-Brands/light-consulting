/**
 * Deliverable Link Card Component
...
interface DeliverableLinkCardProps {
  link: DeliverableLink;
  onEdit?: (id: string) => void;
  onDelete?: (id: string) => void;
}

const LINK_TYPE_CONFIG: Record<DeliverableLinkType, { label: string; color: string; icon: React.ReactNode }> = {
  document: {
    label: 'Document',
...
export const DeliverableLinkCard: React.FC<DeliverableLinkCardProps> = ({
  link,
  onEdit,
  onDelete,
}) => {
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-3 text-xs">
            ...
            {!link.is_client_visible && (
              <span className="px-2 py-1 rounded-full bg-gray-500/10 text-gray-400">
                Internal only
              </span>
            )}
...
export default DeliverableLinkCard;
