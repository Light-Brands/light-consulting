...
const navItems: NavItem[] = [
  {
    ...
    matchPaths: ['/admin/command-center', '/admin'],
    icon: (
  ...
  },
  {
    ...
    matchPaths: ['/admin/prospects', '/admin/leads', '/admin/proposals'],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    label: 'Brands',
    href: '/admin/brands',
    matchPaths: ['/admin/brands', '/admin/clients', '/admin/client-projects', '/admin/work'],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    label: 'Manage',
    href: '/admin/manage',
    matchPaths: ['/admin/manage', '/admin/team', '/admin/users', '/admin/financials', '/admin/analytics'],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const MobileAdminNav: React.FC = () => {
  ...
  const isActive = (item: NavItem) => {
    // Command matches /admin exactly or /admin/command-center
    if (item.label === 'Command') {
      return pathname === '/admin' || pathname.startsWith('/admin/command-center');
    }
