...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project, index = 0 }) => {
  return (
    <motion.article
      ...
      className="group relative bg-depth-surface rounded-2xl overflow-hidden border border-depth-border hover:border-radiance-gold/30 transition-all duration-500"
      role="article"
      ...
      <div className="p-6">
        ...
        {project.case_study_url && (
          <Link
            ...
            className={cn(
              'inline-flex items-center gap-2 text-radiance-gold text-sm font-medium',
              'hover:text-radiance-amber transition-colors group/link'
            )}
