...
import { SERVICES, SUCCESS_METRICS } from '../lib/constants';
        ...
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              <div className="w-20 h-20 rounded-2xl bg-radiance-gold/10 text-radiance-gold flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              <div className="w-20 h-20 rounded-2xl bg-radiance-amber/10 text-radiance-amber flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              <div className="w-20 h-20 rounded-2xl bg-clarity-cream/10 text-clarity-cream flex items-center justify-center mx-auto mb-6">
