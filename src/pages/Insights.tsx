...
const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      '2008 was another moment for mobile. The iPhone had just launched, and suddenly computing was personal, portable, and always-on. Companies that understood this shift early (Instagram in 2010, Uber in 2009, WhatsApp in 2009) built billion-dollar businesses on a platform their competitors dismissed as a toy.',
    ...
    keyTakeaways: [
      ...
      'Unlike previous shifts, AI can be applied to existing businesses immediately with no new infrastructure required',
