...
export const PORTFOLIO_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tags: ['Hospitality Management', 'Real Estate', 'Consulting', 'Client Portals', 'Webflow'],
  ...
  },
  {
    ...
    tags: ['Luxury Apartments', 'Real Estate', 'Hospitality', 'Accommodation', 'React', 'Next.js'],
  ...
  },
  {
    ...
    tags: ['Self-Catering', 'Real Estate', 'Hospitality', 'Accommodation', 'React', 'Next.js'],
  ...
  },
  {
    ...
    tags: ['Holiday Apartments', 'Real Estate', 'Hospitality', 'Booking', 'React', 'Next.js'],
  ...
  },
  {
    ...
    tags: ['Consulting', 'Real Estate', 'Strategy', 'React', 'Next.js'],
  ...
  {
    id: '51',
    title: 'GVG Enterprises',
    description: 'Strategic business development and growth consulting for medical, wellness, and technology companies. Delivered global expansion strategy, market penetration planning, and scalable business architecture for international growth.',
    image_url: '/images/portfolio/gvg-enterprises.jpg',
    tags: ['Business Development', 'Growth Strategy', 'International Expansion', 'Medical', 'Wellness'],
    case_study_url: 'https://www.gvgenterprises.com',
    client_name: 'GVG Enterprises',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('gvg-enterprises'),
    services: ['Business Development Strategy', 'International Expansion', 'Market Penetration Planning', 'Scalable Business Architecture'],
    key_features: ['Global expansion planning', 'Medical clinic partnerships', 'Distribution network development', 'Long-term market strategy'],
    ...
    results: ['Led global expansion opening 17 international distributors (2011-2015)', 'Supported 500+ medical clinics implementing protocols', 'Oversaw distribution of 1M+ protein product boxes annually', 'Built scalable strategies for long-term market penetration'],
    tech_stack: { frontend: 'Not applicable', backend: 'Business consulting' },
    origin: 'US',
  ...
  },
  {
    id: '52',
    title: 'IDEAL Protein',
    description: 'Executive leadership and strategic business development for a global medical weight-loss and metabolic health company. Provided organizational leadership, international operations management, and strategic initiatives that contributed to significant company valuation growth.',
    image_url: '/images/portfolio/ideal-protein.jpg',
    tags: ['Healthcare', 'Weight Loss', 'International Operations', 'Strategic Leadership', 'Business Development'],
    case_study_url: 'https://www.idealprotein.com',
    client_name: 'IDEAL Protein',
    industry: 'Healthcare / Medical Weight Loss',
    featured: true,
    status: 'published',
    sort_order: 52,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'healthcare-wellness',
    gallery_images: getGalleryImages('ideal-protein'),
    services: ['Executive Leadership', 'International Operations', 'Strategic Business Development', 'Valuation Growth Initiatives'],
    key_features: ['Multi-country operations management', 'Medical partner network expansion', 'Investment deal support', 'Strategic growth initiatives'],
    ...
    results: ['Led and managed 250 employees across Canada and U.S.', 'Oversaw international operations across 19 countries', 'Supported 4,000+ medical partner clinics worldwide', 'Contributed to $377M investment deal (65% stake, $580M valuation)', 'Supported initiatives elevating valuation to $880M USD in 2017'],
    tech_stack: { frontend: 'Not applicable', backend: 'Enterprise operations' },
    origin: 'US',
  ...
  },
  {
    id: '53',
    title: 'PandaPay',
    description: 'Co-founded and scaled a Canadian merchant services provider offering Interac and credit card payment processing nationwide. Built infrastructure, merchant acquisition strategies, and portfolio management leading to a successful multi-8-digit exit.',
    image_url: '/images/portfolio/pandapay.jpg',
    tags: ['FinTech', 'Payment Processing', 'Merchant Services', 'Portfolio Management', 'Exit Strategy'],
    case_study_url: 'https://www.pandapay.ca',
    client_name: 'PandaPay',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'ai-technology',
    gallery_images: getGalleryImages('pandapay'),
    services: ['Company Building', 'Merchant Acquisition', 'Payment Infrastructure', 'Portfolio Management', 'Exit Strategy'],
    key_features: ['National payment processing', 'Interac integration', 'Credit card processing', 'Merchant portfolio development'],
    ...
    results: ['Built portfolio of 8,000 merchants across Canada', 'Developed national payment processing infrastructure', 'Completed multi-8-digit portfolio exit in 2024', 'Established nationwide merchant services presence'],
    tech_stack: { frontend: 'Payment systems', backend: 'Financial infrastructure' },
    origin: 'CA',
  ...
  {
    id: '54',
    title: '9mm Beyond Energy',
    description: 'Strategic advisory and fundraising leadership for a performance-driven functional energy supplement company. Built complete corporate infrastructure and executed long-term growth strategy with successful capital raise.',
    image_url: '/images/portfolio/9mm-beyond-energy.jpg',
    tags: ['Supplements', 'Fundraising', 'Corporate Structure', 'Growth Strategy', 'Capital Raise'],
    case_study_url: 'https://www.9mmbeyondenergy.com',
    client_name: '9mm Beyond Energy',
    industry: 'Consumer Products / Supplements',
    featured: false,
    status: 'published',
    sort_order: 54,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'healthcare-wellness',
    gallery_images: getGalleryImages('9mm-beyond-energy'),
    services: ['Strategic Advisory', 'Fundraising', 'Corporate Structure Development', 'Growth Strategy'],
    key_features: ['Investment capital raising', 'Legal structure development', 'Financial architecture', 'Expansion strategy'],
    ...
    results: ['Raised $1.7M USD in investment capital', 'Built complete legal and financial structure', 'Designed corporate architecture', 'Executed long-term growth and expansion strategy'],
    tech_stack: { frontend: 'Not applicable', backend: 'Strategic consulting' },
    origin: 'US',
  ...
  },
  {
    id: '55',
    title: 'Dimes Energy',
    description: 'Investment strategy consulting for an energy exploration and drilling company. Developed capital expansion strategies, supported fundraising efforts, and provided corporate structure and investor positioning guidance.',
    image_url: '/images/portfolio/dimes-energy.jpg',
    tags: ['Energy', 'Investment Strategy', 'Capital Expansion', 'Drilling Operations', 'Investor Relations'],
    case_study_url: 'https://www.dimesenergy.com',
    client_name: 'Dimes Energy',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'real-estate-energy',
    gallery_images: getGalleryImages('dimes-energy'),
    services: ['Investment Strategy', 'Capital Expansion', 'Investor Relations', 'Corporate Structure'],
    key_features: ['Drilling operations funding', 'Investor positioning', 'Financial planning', 'Corporate structure advisory'],
    ...
    results: ['Helped raise $10M USD for drilling operations', 'Developed capital expansion strategy', 'Supported corporate structure development', 'Enhanced investor positioning and relations'],
    tech_stack: { frontend: 'Not applicable', backend: 'Investment consulting' },
    origin: 'US',
  ...
  },
  {
    ...
    description: 'Investment strategy consulting for an energy-focused company pursuing innovative technologies and capital expansion initiatives. Provided strategic investor introductions and early-stage structuring for future growth rounds.',
    image_url: '/images/portfolio/quantum-energy.jpg',
    tags: ['Energy', 'Investment Strategy', 'Investor Relations', 'Capital Raising', 'Early Stage'],
    case_study_url: 'https://www.quantumenergy.com',
    client_name: 'Quantum Energy',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'real-estate-energy',
    gallery_images: getGalleryImages('quantum-energy'),
    services: ['Investment Strategy', 'Investor Relations', 'Strategic Introductions', 'Early-Stage Structuring'],
    key_features: ['Capital positioning', 'Investor introductions', 'Growth round preparation', 'Strategic investment advisory'],
    ...
    results: ['Helped raise $300K USD in private investment', 'Introduced strategic investors', 'Facilitated investor relations', 'Prepared company for future growth rounds'],
    tech_stack: { frontend: 'Not applicable', backend: 'Investment consulting' },
    origin: 'US',
    project_type: 'Investment Strategy Consulting',
    preview_enabled: false,
  ...
  {
    id: '57',
    title: 'Creative TRND + SEO TWIST',
    description: 'M&A advisory and capital raise support for a strategic merger between two digital marketing and SEO agencies. Facilitated the merger process, secured growth capital, and advised on organizational integration and scaling strategy.',
    image_url: '/images/portfolio/creative-trnd-seo-twist.jpg',
    tags: ['M&A', 'Digital Marketing', 'SEO', 'Capital Raise', 'Agency Consolidation'],
    case_study_url: 'https://www.creativetrnd.com',
    client_name: 'Creative TRND / SEO TWIST',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('creative-trnd-seo-twist'),
    services: ['M&A Advisory', 'Capital Raise', 'Organizational Integration', 'Scaling Strategy'],
    key_features: ['Merger facilitation', 'Post-merger capital raise', 'Corporate architecture', 'Integration planning'],
    ...
    results: ['Facilitated successful merger between agencies', 'Helped secure $1.6M in post-merger capital', 'Advised on organizational integration', 'Developed corporate architecture and scaling strategy'],
    tech_stack: { frontend: 'Not applicable', backend: 'M&A consulting' },
    origin: 'US',
  ...
  {
    id: '58',
    title: 'Ottawa International Jazz Festival',
    description: 'Helped raise millions of dollars through fundraising initiatives supporting one of Canada\'s premier cultural festivals. Delivered strategic fundraising campaigns and donor engagement strategies for this nationally recognized arts organization.',
    image_url: '/images/portfolio/ottawa-jazz-festival.jpg',
    tags: ['Nonprofit', 'Fundraising', 'Cultural Events', 'Arts', 'Canada'],
    case_study_url: 'https://ottawajazzfestival.com',
    client_name: 'Ottawa International Jazz Festival',
    industry: 'Nonprofit / Cultural Events',
    featured: false,
    status: 'published',
    sort_order: 58,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'community-social',
    gallery_images: getGalleryImages('ottawa-jazz-festival'),
    services: ['Fundraising Strategy', 'Donor Engagement', 'Campaign Management'],
    key_features: ['Multi-million dollar fundraising', 'Donor cultivation', 'Event sponsorship', 'Cultural programming support'],
    ...
    results: ['Raised millions of dollars in funding', 'Established sustainable donor relationships', 'Supported festival growth and programming', 'Enhanced community engagement'],
    tech_stack: { frontend: 'Not applicable', backend: 'Nonprofit consulting' },
    origin: 'CA',
  ...
  {
    id: '59',
    title: 'World Vision — 30-Hour Famine',
    description: 'Led the funding component of national campaigns, helping raise hundreds of thousands of dollars while mobilizing youth leaders across Canada. Managed large-scale fundraising initiatives and youth engagement programs for this global humanitarian organization.',
    image_url: '/images/portfolio/world-vision-famine.jpg',
    tags: ['Nonprofit', 'Fundraising', 'Youth Leadership', 'Humanitarian', 'National Campaigns'],
    case_study_url: 'https://www.worldvision.ca',
    client_name: 'World Vision Canada',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'community-social',
    gallery_images: getGalleryImages('world-vision-famine'),
    services: ['National Campaign Leadership', 'Youth Mobilization', 'Fundraising Management'],
    key_features: ['National campaign coordination', 'Youth leader development', 'Large-scale fundraising', 'Community mobilization'],
    ...
    results: ['Raised hundreds of thousands of dollars', 'Mobilized youth leaders across Canada', 'Built sustainable youth engagement programs', 'Supported global humanitarian initiatives'],
    tech_stack: { frontend: 'Not applicable', backend: 'Nonprofit consulting' },
    origin: 'CA',
  ...
  {
    id: '60',
    title: 'New Renaissance',
    description: 'Founded and led a nonprofit movement from the ground up over 8 years as Executive Director. Built a community of 250+ young adults meeting weekly, supporting entrepreneurship, creativity, and leadership while helping reconnect a generation to faith, identity, and purpose. Expanded across Canada with sustained long-term impact.',
    image_url: '/images/portfolio/new-renaissance.jpg',
    tags: ['Nonprofit', 'Community Building', 'Leadership Development', 'Youth Movement', 'Faith-Based'],
    case_study_url: null,
    client_name: 'New Renaissance',
    industry: 'Nonprofit / Community Movement',
    featured: true,
    status: 'published',
    sort_order: 60,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'community-social',
    gallery_images: getGalleryImages('new-renaissance'),
    services: ['Movement Building', 'Leadership Development', 'Community Organizing', 'Program Development'],
    key_features: ['250+ weekly participants', '8-year sustained operation', 'Cross-Canada expansion', 'Entrepreneurship support'],
    ...
    results: ['Built community of 250+ young adults meeting weekly', 'Operated successfully for 8 years', 'Expanded movement across Canada', 'Helped reconnect a generation to faith, identity, and purpose'],
    tech_stack: { frontend: 'Not applicable', backend: 'Nonprofit leadership' },
    origin: 'CA',
  ...
  {
    id: '61',
    title: 'Carlington Booch',
    description: 'Helped build a mission-driven kombucha brand from scratch as a social enterprise. Developed the e-commerce brand and business foundation where 100% of revenue supports addiction recovery and reintegration programs.',
    image_url: '/images/portfolio/carlington-booch.jpg',
    tags: ['Social Enterprise', 'E-commerce', 'Brand Development', 'Addiction Recovery', 'Mission-Driven'],
    case_study_url: 'https://carlingtonbooch.com',
    client_name: 'Carlington Booch',
    industry: 'Social Enterprise / Beverage',
    featured: false,
    status: 'published',
    sort_order: 61,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'community-social',
    gallery_images: getGalleryImages('carlington-booch'),
    services: ['Brand Development', 'E-commerce Build', 'Business Foundation', 'Social Enterprise Strategy'],
    key_features: ['Mission-driven brand', '100% revenue to recovery programs', 'E-commerce platform', 'Social impact model'],
    ...
    results: ['Built mission-driven brand from scratch', 'Established e-commerce foundation', '100% revenue supports addiction recovery', 'Created sustainable social enterprise model'],
    tech_stack: { frontend: 'E-commerce platform', backend: 'Business systems' },
    origin: 'CA',
  ...
  {
    id: '62',
    title: 'Ashes to Rubies',
    description: 'Helped create LifeLab, an addiction recovery and reintegration program that has helped hundreds of individuals overcome addiction. Supported curriculum development, program structure, and delivery rooted in dignity and identity transformation.',
    image_url: '/images/portfolio/ashes-to-rubies.jpg',
    tags: ['Addiction Recovery', 'Program Development', 'Social Impact', 'Reintegration', 'Nonprofit'],
    case_study_url: 'https://ashestorubies.com',
    client_name: 'Ashes to Rubies',
    industry: 'Addiction Recovery / Social Impact',
    featured: true,
    status: 'published',
    sort_order: 62,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'healthcare-wellness',
    gallery_images: getGalleryImages('ashes-to-rubies'),
    services: ['Program Development', 'Curriculum Design', 'Recovery Framework', 'Reintegration Strategy'],
    key_features: ['LifeLab recovery program', 'Dignity-centered approach', 'Identity transformation', 'Reintegration support'],
    ...
    results: ['Helped hundreds overcome addiction', 'Built sustainable recovery program', 'Created reintegration pathways', 'Established dignity-centered approach'],
    tech_stack: { frontend: 'Not applicable', backend: 'Program development' },
    origin: 'CA',
  ...
  {
    id: '63',
    title: 'Shifter Magazine',
    description: 'Co-founded and published a cultural media platform, building and scaling the magazine from the ground up. Covered major events including Juno Awards, International Film Festivals, and Academy Awards. Launched and elevated countless creatives before successfully exiting; the magazine continues to operate today.',
    image_url: '/images/portfolio/shifter-magazine.jpg',
    tags: ['Media', 'Publishing', 'Cultural Platform', 'Entertainment', 'Startup Exit'],
    case_study_url: 'https://shiftermagazine.com',
    client_name: 'Shifter Magazine',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('shifter-magazine'),
    services: ['Media Platform Development', 'Editorial Leadership', 'Brand Building', 'Creative Talent Development'],
    key_features: ['Major event coverage', 'Artist platform', 'Editorial excellence', 'Successful exit'],
    ...
    results: ['Built and scaled magazine from ground up', 'Covered Juno Awards, Film Festivals, Academy Awards', 'Launched countless creative careers', 'Successfully exited; magazine continues operating'],
    tech_stack: { frontend: 'Media platform', backend: 'Publishing systems' },
    origin: 'CA',
  ...
  },
  {
    id: '64',
    title: 'TALK',
    description: 'Supported brand and creative strategy during rapid growth for this Juno Award-winning artist. Provided strategic guidance on positioning, brand development, and creative direction as the artist scaled to selling out stadiums internationally.',
    image_url: '/images/portfolio/talk-artist.jpg',
    tags: ['Music', 'Artist Development', 'Brand Strategy', 'Creative Direction', 'Entertainment'],
    case_study_url: 'https://www.iamtalkmusic.com',
    client_name: 'TALK',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('talk-artist'),
    services: ['Brand Strategy', 'Creative Direction', 'Artist Positioning', 'Growth Strategy'],
    key_features: ['Juno Award winner', 'International stadium tours', 'Brand development', 'Rapid growth support'],
    ...
    results: ['Supported Juno Award-winning artist', 'Guided brand through rapid growth', 'Artist now sells out stadiums internationally', 'Built sustainable creative brand'],
    tech_stack: { frontend: 'Not applicable', backend: 'Artist consulting' },
    origin: 'CA',
  ...
  },
  {
    id: '65',
    title: 'Shaneen Megji',
    description: 'Built personal brand and flagship offer from the ground up. Helped launch coaching business with complete brand development, positioning strategy, and offer creation for sustainable business growth.',
    image_url: '/images/portfolio/shaneen-megji.jpg',
    tags: ['Personal Brand', 'Coaching', 'Offer Development', 'Brand Strategy', 'Business Launch'],
    case_study_url: 'https://www.shaneenmegji.com',
    client_name: 'Shaneen Megji',
    ...
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('shaneen-megji'),
    services: ['Personal Brand Development', 'Offer Creation', 'Business Launch', 'Positioning Strategy'],
    key_features: ['Complete brand build', 'Flagship offer development', 'Coaching business launch', 'Sustainable growth strategy'],
    ...
    results: ['Built personal brand from ground up', 'Launched flagship coaching offer', 'Established coaching business', 'Created sustainable growth foundation'],
    tech_stack: { frontend: 'Not applicable', backend: 'Brand consulting' },
    origin: 'CA',
  ...
  {
    id: '66',
    title: 'Performance Window Cleaning',
    description: 'Built from the ground up with a 21-year-old founder. Developed brand, business systems, and growth strategy that scaled the company to approximately $3M/year in revenue.',
    image_url: '/images/portfolio/performance-window-cleaning.jpg',
    tags: ['Service Business', 'Business Development', 'Brand Building', 'Growth Strategy', 'Startup'],
    case_study_url: 'https://performancewindowcleaning.com',
    client_name: 'Performance Window Cleaning',
    industry: 'Service Business / Commercial Cleaning',
    featured: true,
    status: 'published',
    sort_order: 66,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('performance-window-cleaning'),
    services: ['Business Development', 'Brand Building', 'Growth Strategy', 'Systems Development'],
    key_features: ['Ground-up business build', 'Young founder mentorship', '$3M annual revenue', 'Scalable systems'],
    ...
    results: ['Built business from ground up', 'Scaled to ~$3M/year revenue', 'Developed scalable systems', 'Mentored young founder to success'],
    tech_stack: { frontend: 'Not applicable', backend: 'Business consulting' },
    origin: 'CA',
  ...
  },
  {
    id: '67',
    title: 'We Scale It',
    description: 'Worked with CEO Charles Lecasse to redesign the entire business model. Transformed the company to now generate approximately $50K/month, serving French-owned businesses with scalable growth solutions.',
    image_url: '/images/portfolio/we-scale-it.jpg',
    tags: ['Business Consulting', 'Business Model Design', 'Revenue Growth', 'French Market', 'Scaling'],
    case_study_url: 'https://wescaleit.ca',
    client_name: 'We Scale It',
    industry: 'Business Consulting / Growth',
    featured: false,
    status: 'published',
    sort_order: 67,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    brand_id: 'creative-professional',
    gallery_images: getGalleryImages('we-scale-it'),
    services: ['Business Model Redesign', 'Revenue Strategy', 'Market Positioning', 'Growth Consulting'],
    key_features: ['Complete business model redesign', '$50K/month revenue', 'French market focus', 'Scalable solutions'],
    ...
    results: ['Redesigned entire business model', 'Generating ~$50K/month', 'Established French market presence', 'Built scalable growth solutions'],
    tech_stack: { frontend: 'Not applicable', backend: 'Business consulting' },
    origin: 'CA',
