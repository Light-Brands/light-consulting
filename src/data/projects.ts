...
export const PORTFOLIO_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    key_features: ['Social feeds', 'Real-time messaging', 'Community features', 'User profiles', 'Engagement tools'],
    challenge: 'Building a scalable, engaging social platform that fosters genuine community connections.',
    solution: 'Created a full-featured community platform with real-time capabilities and intuitive social features.',
    results: ['Growing active user base', 'High engagement rates', 'Strong community formation'],
