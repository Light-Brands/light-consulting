    ...
    milestones: [
      {
        ...
        description: 'After payment is received, we begin the engagement',
        amount: 5000,
        due_date: null,
      ...
      },
      {
        ...
        proposal_id: 'cho-ventures-001',
        phase_id: 'cho-phase-1',
        milestone_name: 'Ecosystem Strategy Session',
        description: 'Deep-dive session to understand your current systems, workflows, and AI opportunities',
        amount: null,
        due_date: null,
        payment_status: null,
        milestone_status: 'not_started',
      ...
      },
      {
        ...
        proposal_id: 'cho-ventures-001',
        phase_id: 'cho-phase-1',
        milestone_name: 'Review Documents',
        description: 'Review and refinement of ecosystem map, opportunity matrix, and recommendations',
        amount: null,
        due_date: null,
        payment_status: null,
        milestone_status: 'not_started',
      ...
      },
      {
        ...
        description: 'Final presentation and delivery of all diagnostic materials',
        amount: null,
        due_date: null,
        payment_status: null,
        milestone_status: 'not_started',
